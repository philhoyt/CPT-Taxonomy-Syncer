...
wp cpt-tax-syncer generate_test_data your_cpt your_taxonomy --count=50

# Create 200 test posts WITHOUT terms (for testing bulk sync)
wp cpt-tax-syncer generate_test_data your_cpt your_taxonomy --count=200 --skip-sync

# Create 200 test posts with corresponding terms and meta relationships
wp cpt-tax-syncer generate_test_data your_cpt your_taxonomy --count=200 --create-terms

# Create 1000 posts for stress testing (without auto-sync)
wp cpt-tax-syncer generate_test_data your_cpt your_taxonomy --count=1000 --skip-sync
```
...
wp cpt-tax-syncer test_sync your_cpt your_taxonomy posts-to-terms

# Test syncing terms to posts with custom batch size
wp cpt-tax-syncer test_sync your_cpt your_taxonomy terms-to-posts --batch-size=50

# Test with verbose output (shows per-batch details)
wp cpt-tax-syncer test_sync your_cpt your_taxonomy posts-to-terms --verbose
```
...
wp cpt-tax-syncer verify your_cpt your_taxonomy

# Check and attempt to fix issues
wp cpt-tax-syncer verify your_cpt your_taxonomy --fix
```
...
wp cpt-tax-syncer cleanup your_cpt your_taxonomy

# Clean up without confirmation
wp cpt-tax-syncer cleanup your_cpt your_taxonomy --confirm
```
...
wp cpt-tax-syncer generate_test_data your_cpt your_taxonomy --count=500 --skip-sync
...
wp cpt-tax-syncer test_sync your_cpt your_taxonomy terms-to-posts --verbose
...
wp cpt-tax-syncer test_sync your_cpt your_taxonomy posts-to-terms --batch-size=25 --verbose

# Test with default batch size
wp cpt-tax-syncer test_sync your_cpt your_taxonomy posts-to-terms --batch-size=100 --verbose

# Test with large batches (less overhead, more memory)
wp cpt-tax-syncer test_sync your_cpt your_taxonomy posts-to-terms --batch-size=200 --verbose
```
...
wp cpt-tax-syncer generate_test_data your_cpt your_taxonomy --count=5000 --skip-sync
...
# Setup
wp cpt-tax-syncer generate_test_data your_cpt your_taxonomy --count=100
